...
export const projects: Project[] = [
  {
    ...
    thumbnail: 'https://images.unsplash.com/photo-1542281286-9e0a16bb7366?auto=format&fit=crop&q=80&w=1200',
    description: 'Deployed YOLOv8 and Detectron2 on Jetson Nano for real-time gas pipeline defect detection, integrated into a robotic platform.',
    ...
    images: ['https://images.unsplash.com/photo-1513828583688-c52646db42da?auto=format&fit=crop&q=80&w=1200'],
  ...
  },
  {
    ...
    thumbnail: 'https://www.zund.com/uploads/media/700x400/00/4000-Dectura_Leder_Workflow_Blogpost3.jpg?v=1-0',
    description: 'My undergraduate thesis, employing Detectron2 for defect segmentation and YOLOv8 for hair root detection, achieving mAP50 of 0.995.',
    ...
    images: ['https://www.zund.com/uploads/media/700x400/00/4000-Dectura_Leder_Workflow_Blogpost3.jpg?v=1-0'],
    technologies: ['Python', 'Detectron2', 'YOLOv8', 'ResNet50', 'Computer Vision'],
    repoLink: '#'
  },
  {
    slug: 'ride-sharing-system',
    title: 'Ride-Sharing System Architecture',
    category: 'Software Engineering',
    thumbnail: 'https://images.unsplash.com/photo-1449965408869-eaa3f722e40d?auto=format&fit=crop&q=80&w=1200',
    ...
    images: ['https://images.unsplash.com/photo-1551288049-bebda4e38f71?auto=format&fit=crop&q=80&w=1200'],
  ...
  },
  {
    ...
    images: ['https://images.unsplash.com/photo-1414235077428-338989a2e8c0?auto=format&fit=crop&q=80&w=1200'],
    technologies: ['Python', 'OOP', 'System Design'],
    liveLink: '#',
    repoLink: '#'
  }
...
export const blogPosts: BlogPost[] = [
  {
    ...
    excerpt: 'YOLOv8 has taken the computer vision world by storm. In this article, we dive deep into its architecture, performance improvements, and benchmarks.',
    content: `
## Introduction
...
YOLOv8 is a powerful and flexible framework that is suitable for a wide range of object detection tasks. Its user-friendly API, combined with state-of-the-art performance, makes it an excellent choice for both researchers and developers. As the field continues to evolve, YOLOv8 has firmly established itself as a key player.
    `,
    featuredImage: 'https://images.unsplash.com/photo-1555949963-ff9fe0c870eb?auto=format&fit=crop&q=80&w=1200',
    category: 'Computer Vision'
  },
  {
    ...
    date: '2023-11-15',
    author: 'MD. SABBIR RAHMAN AKASH',
    excerpt: 'Innovation can be the key to solving our environmental challenges. We explore "Green Tech" and its role in a sustainable world.',
    content: `
...
The path to a greener future requires a fundamental shift in how we design, build, and consume technology. It's a challenge that requires collaboration between engineers, policymakers, and consumers, but it's a challenge we must meet.
    `,
    featuredImage: 'https://images.unsplash.com/photo-1473341304170-971dccb5ac1e?auto=format&fit=crop&q=80&w=1200',
    category: 'Technology'
  }
];
...
export const researchProjects: ResearchProject[] = [
    {
        ...
        title: 'THESIS: Automated Grading System for Finished Leather',
        institution: 'Khulna University of Engineering & Technology (KUET)',
        duration: '2020-2024',
        supervisor: 'Prof. Dr. Md. Abul Hashem',
        description: 'Employs Detectron2 with ResNet50 for defect instance segmentation and YOLOv8 for hair roots detection.',
        longDescription: 'This undergraduate thesis project developed a novel system for automatically grading finished leather. It involved creating a custom dataset, training deep learning models, and achieving over 95% accuracy in classifying leather into four distinct grades. The work was published and presented at an international conference.',
        image: 'https://www.zund.com/uploads/media/700x400/00/4000-Dectura_Leder_Workflow_Blogpost3.jpg?v=1-0',
    },
    {
        slug: 'compost-technique-research',
        title: 'Journal: Atypical co-composting technique for tannery limed fleshing',
        institution: 'Md. Abul Hashem\'s Lab',
        duration: 'Published 2024',
        supervisor: 'Prof. Dr. Md. Abul Hashem',
        description: 'Developed an atypical co-composting technique to transform tannery limed fleshing into nutrient-rich compost.',
    ...
    },
    {
        ...
        title: 'Conference: Bagasse for goatskin preservation to reduce chloride',
        institution: 'Research Project',
        duration: '2020',
        supervisor: 'Research Team',
        description: 'Sustainable goat skin preservation methods using plant-based alternatives to reduce environmental impact.',
    ...
    },
    {
        ...
        title: 'Conference: Adsorption of chromium on russet potato peel charcoal',
        institution: 'Environmental Science Research',
        duration: '2021',
        supervisor: 'Lab Team',
        description: 'Investigated chromium adsorption from tannery wastewater using russet potato peel charcoal, achieving 98.9% removal.',
        ...
        image: 'https://i.imgur.com/9KAJR8t.png',
    },
];
...
export const awards: Award[] = [
    {
        ...
        title: 'Winner & Best Poster Presentation Award',
        organization: 'KUET Leather Engineering Seminar Series 2023',
        date: 'September 2023',
        description: 'Awarded for research on Biodegradable Solid Waste (Orange Peel) Preserved Goat Skin.',
    ...
    },
    {
        ...
        organization: 'Red & White Innovations (National Level)',
        date: 'January 2021',
        description: 'Secured second place for a Health Based Case Study Competition focused on brainstorming new ideas.',
        longDescription: 'Our team developed a concept for a low-cost, biodegradable material from industrial waste. The project was judged on its feasibility, market potential, and environmental impact.',
    ...
    },
    {
        ...
        organization: 'IIT, University of Dhaka (National Level)',
        date: 'December 2020',
        description: 'Achieved third place in an IT-based Case Study Competition focused on creative solutions.',
        longDescription: 'The challenge was to redesign a common household item to be more sustainable and user-friendly. Our team redesigned a water purifier to use less plastic and incorporate recyclable filters.',
    ...
    },
    {
        ...
        date: 'May 2020',
        description: 'Placed 6th in a business case study competition to research and identify a new business location.',
    ...
    },
    {
        ...
        image: 'https://images.unsplash.com/photo-1523050335456-c3874cbb6811?auto=format&fit=crop&q=80&w=800',
    },
];
